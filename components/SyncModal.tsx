    ...
    <div className="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center z-50 p-4">
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl w-full max-w-lg m-4 transform transition-all">
        <div className="p-6 border-b border-gray-200 dark:border-gray-700">
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-3">
              ...
              <h2 className="text-xl font-semibold text-gray-900 dark:text-white">Setup Synchronization</h2>
            </div>
        ...
        <form onSubmit={handleSync}>
            ...
            <div className="p-6 bg-white dark:bg-gray-800 rounded-b-lg flex justify-end space-x-3">
