      ...
      <div className="bg-gray-800 rounded-lg shadow-xl w-full max-w-2xl m-4 transform transition-all flex flex-col" style={{maxHeight: '90vh'}}>
        <div className="p-6 border-b border-gray-700">
          <div className="flex justify-between items-center">
            <h2 className="text-xl font-semibold text-white">Generate README for {project.name}</h2>
        ...
        <div className="p-6 flex-1 overflow-y-auto space-y-4">
          {!generatedContent ? (
            <>
              <div>
                ...
                <textarea
                  ...
                  className="w-full bg-gray-700 text-white rounded-md p-2 border border-gray-600 focus:ring-blue-500 focus:border-blue-500"
            ...
            <div>
              <h3 className="text-lg font-medium text-white mb-2">Generated README.md</h3>
              <pre className="bg-gray-900 text-gray-300 p-4 rounded-md whitespace-pre-wrap font-mono text-sm overflow-x-auto">
